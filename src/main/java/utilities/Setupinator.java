...
public class Setupinator {
    public static ChromeDriver driver;


    public Setupinator() throws IOException {
    ...
    public static Properties getProperties() throws IOException {
        ...
        InputStream inputStream = Setupinator.class.getClassLoader().getResourceAsStream("config.properties");
